...
from apis.cinema_admin.utils import cinema_users_permission
from models.cinema_admin.cinema_address_model import CinemaAddress
from models.cinema_admin.permissions_constant import PERMISSION_WRITE
...
class CinemaAddressesResource(Resource):
    ...
    @cinema_users_permission(PERMISSION_WRITE)
    def post(self):
        print('*****')
